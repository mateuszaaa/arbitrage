...
TEST(Parser_test, seccond_test){
    ...
    input = string.load(
        R"(
            [{"symbol":"ETHBTC","bidPrice":"0.03174400","bidQty":"0.25500000","askPrice":"0.03174900","askQty":"24.00000000"},
    ...
    output.push_back(valut1);
    output.push_back(valut2);
    output.push_back(valut3);
